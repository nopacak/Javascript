...
Officer: 4335840
CaseNum: 402-3-12007186-4335840
...
function draw()
{
    ...
    if(det.locationY > 143)
    {
        det.speedX = -1;
        det.speedY = 0;
    }
    
    if(det.locationX < 377)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    ...
    if(det.locationX > 695 && det.locationY > 195)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    ...
    if(det.locationX < 187 && det.locationY > 320)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    ...
    if(det.locationX > 580 && det.locationY > 450)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    
    if(det.locationY > 580)
    {
       det.speedX = -1;
       det.speedY = 0;
    }
    
    if(det.locationX < 252 && det.locationY > 580)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    
    if(det.locationY > 640)
    {
       det.speedX = 1;
       det.speedY = 0;
    }
    
    if(det.locationX > 705 && det.locationY > 640)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
