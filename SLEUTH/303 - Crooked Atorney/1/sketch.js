...
Officer: 4335840
CaseNum: 303-0-20137776-4335840
...
var secure_locker_combination_0;
var secure_locker_combination_1;
...
function setup()
{
	...
	secure_locker_combination_0 = 0;
	secure_locker_combination_1 = 0;
...
function mouseMoved()
{
    ...
    secure_locker_combination_0=23;
    secure_locker_combination_1=76;
}
...
function mousePressed()
{
    ...
    secure_locker_combination_0=15;
    secure_locker_combination_1=10;
}

function mouseReleased()
{
	console.log("mouseReleased");
    secure_locker_combination_0=3;
    secure_locker_combination_1=63;
}

function keyPressed()
{
	console.log("keyPressed", key);
    secure_locker_combination_0=20;
}

function keyReleased()
{
	console.log("keyReleased", key);
    secure_locker_combination_1=45;
}
...
function draw()
{
	...
	drawDial(200, secure_locker_combination_0, 28);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(secure_locker_combination_1);
	pop();
